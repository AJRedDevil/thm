...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Commission.jobs'
        db.delete_column(u'commcalc_commission', 'jobs_id')

        # Adding field 'Commission.job'
        db.add_column(u'commcalc_commission', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='commission', to=orm['jobs.Jobs']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Commission.jobs'
        raise RuntimeError("Cannot reverse this migration. 'Commission.jobs' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Commission.jobs'
        db.add_column(u'commcalc_commission', 'jobs',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='commission', to=orm['jobs.Jobs']),
                      keep_default=False)

        # Deleting field 'Commission.job'
        db.delete_column(u'commcalc_commission', 'job_id')
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'4b696feb648442ff89616ec11b7813cf'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'b42d81837553425497dfaf556756a020'", 'unique': 'True', 'max_length': '100'})
        }
    }
