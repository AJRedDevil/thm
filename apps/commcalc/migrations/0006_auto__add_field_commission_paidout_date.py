...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commission.paidout_date'
        db.add_column(u'commcalc_commission', 'paidout_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commission.paidout_date'
        db.delete_column(u'commcalc_commission', 'paidout_date')
    ...
    models = {
        u'commcalc.commission': {
            ...
            'paidout_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'62a14de80d334183aad2866da5f18276'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'8137398b291f4970a6c045e1b1323d27'", 'unique': 'True', 'max_length': '100'})
        }
    }
