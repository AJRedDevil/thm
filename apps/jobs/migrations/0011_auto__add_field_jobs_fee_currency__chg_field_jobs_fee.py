...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jobs.fee_currency'
        db.add_column(u'jobs_jobs', 'fee_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='NPR'),
                      keep_default=False)


        # Changing field 'Jobs.fee'
        db.alter_column(u'jobs_jobs', 'fee', self.gf('djmoney.models.fields.MoneyField')(default_currency='NPR', null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'Jobs.fee_currency'
        db.delete_column(u'jobs_jobs', 'fee_currency')


        # Changing field 'Jobs.fee'
        db.alter_column(u'jobs_jobs', 'fee', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'79cc0f1f88ad4107889dd3d684b43055'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'db1f454cad07493dad4d443488d63424'", 'unique': 'True', 'max_length': '100'})
        }
    }
