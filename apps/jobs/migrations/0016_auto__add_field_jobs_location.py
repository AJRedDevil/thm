...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jobs.location'
        db.add_column(u'jobs_jobs', 'location',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(default='POINT (85.3141498444705064 27.6942413607694782)', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jobs.location'
        db.delete_column(u'jobs_jobs', 'location')
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'e7d0184de46241ad980bf99d43af2072'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'7264fe4869f14a33bb8355923e881413'", 'unique': 'True', 'max_length': '100'})
        }
    }
