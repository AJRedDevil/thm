...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Jobs.available_handymen'
        db.delete_column(u'jobs_jobs', 'available_handymen')


    def backwards(self, orm):
        # Adding field 'Jobs.available_handymen'
        db.add_column(u'jobs_jobs', 'available_handymen',
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'c3f70cc2f7784de99e7ee44e5e4ae070'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'393a6137db4740c2bac0fa6de36ea9ec'", 'unique': 'True', 'max_length': '100'})
        }
    }
