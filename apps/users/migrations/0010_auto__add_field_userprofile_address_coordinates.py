...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.address_coordinates'
        db.add_column(u'users_userprofile', 'address_coordinates',
                      self.gf('jsonfield.fields.JSONField')(default='{}', max_length=9999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.address_coordinates'
        db.delete_column(u'users_userprofile', 'address_coordinates')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'address_coordinates': ('jsonfield.fields.JSONField', [], {'default': "'{}'", 'max_length': '9999'}),
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'46ca7fb7274f45378142a47901ea22c8'", 'unique': 'True', 'max_length': '100'})
        },
        u'users.usertoken': {
