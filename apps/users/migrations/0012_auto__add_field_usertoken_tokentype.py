...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserToken.tokentype'
        db.add_column(u'users_usertoken', 'tokentype',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserToken.tokentype'
        db.delete_column(u'users_usertoken', 'tokentype')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'57f99dd3f9f04693a6909af467c93ced'", 'unique': 'True', 'max_length': '100'})
        },
        u'users.usertoken': {
            ...
            'tokentype': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.UserProfile']"})
        }
    }
