...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobGalleryImages.job'
        db.add_column(u'job_gallery_jobgalleryimages', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', related_name='gallery', to=orm['jobs.Jobs']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobGalleryImages.job'
        db.delete_column(u'job_gallery_jobgalleryimages', 'job_id')
    ...
    models = {
        u'job_gallery.jobgalleryimages': {
            ...
            'job': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'gallery'", 'to': u"orm['jobs.Jobs']"})
        },
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'7ecfac445490405e8da1b47dc0f5654d'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'a07d114ae65a4ac19d86fe4f556d87bc'", 'unique': 'True', 'max_length': '100'})
        }
    }
