...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Jobs.handymen'
        db.delete_column(u'jobs_jobs', 'handymen')

        # Adding field 'Jobs.handyman'
        db.add_column(u'jobs_jobs', 'handyman',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='orders', to=orm['users.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Jobs.handymen'
        db.add_column(u'jobs_jobs', 'handymen',
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'handyman': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders'", 'to': u"orm['users.UserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
