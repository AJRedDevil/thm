...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Jobs.handyman'
        db.alter_column(u'jobs_jobs', 'handyman_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.UserProfile']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Jobs.handyman'
        raise RuntimeError("Cannot reverse this migration. 'Jobs.handyman' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Jobs.handyman'
        db.alter_column(u'jobs_jobs', 'handyman_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile']))
    ...
    models = {
        u'jobs.jobevents': {
            ...
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 28, 0, 0)'})
        },
        u'jobs.jobs': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 28, 0, 0)'}),
