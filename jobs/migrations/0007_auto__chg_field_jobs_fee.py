...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Jobs.fee'
        raise RuntimeError("Cannot reverse this migration. 'Jobs.fee' and its values cannot be restored.")
