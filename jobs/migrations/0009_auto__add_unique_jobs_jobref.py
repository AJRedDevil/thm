...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Jobs', fields ['jobref']
        db.create_unique(u'jobs_jobs', ['jobref'])


    def backwards(self, orm):
        # Removing unique constraint on 'Jobs', fields ['jobref']
        db.delete_unique(u'jobs_jobs', ['jobref'])
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'4787dbfaed9a49e182a65c8382d0c544'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'836ad7b990aa412db4043513171d85b0'", 'unique': 'True', 'max_length': '100'})
        }
    }
