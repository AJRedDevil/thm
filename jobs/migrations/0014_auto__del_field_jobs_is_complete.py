...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Jobs.is_complete'
        db.delete_column(u'jobs_jobs', 'is_complete')


    def backwards(self, orm):
        # Adding field 'Jobs.is_complete'
        db.add_column(u'jobs_jobs', 'is_complete',
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'e7302cdb2e1f45e3b575ee89e4722833'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'a59c996454854529939fc0613fe84f4d'", 'unique': 'True', 'max_length': '100'})
        }
    }
