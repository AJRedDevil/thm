...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Jobs.distance'
        db.delete_column(u'jobs_jobs', 'distance')


    def backwards(self, orm):
        # Adding field 'Jobs.distance'
        db.add_column(u'jobs_jobs', 'distance',
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'a9838f0b25bd4728a3bd84953b464e21'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'8836336b45614524832ac641643f7ebb'", 'unique': 'True', 'max_length': '100'})
        }
    }
