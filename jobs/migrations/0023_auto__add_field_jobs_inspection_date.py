...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jobs.inspection_date'
        db.add_column(u'jobs_jobs', 'inspection_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jobs.inspection_date'
        db.delete_column(u'jobs_jobs', 'inspection_date')
    ...
    models = {
        ...
        u'jobs.jobs': {
            ...
            'jobref': ('django.db.models.fields.CharField', [], {'default': "'4985cb6f796246449d4f6a2ceb4c1ea3'", 'unique': 'True', 'max_length': '100'}),
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'c7899d4d4e894076955fda71bf6ef47a'", 'unique': 'True', 'max_length': '100'})
        }
    }
