...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EarlyBirdUser'
        db.create_table(u'users_earlybirduser', (
        ...
        db.send_create_signal(u'users', ['EarlyBirdUser'])


    def backwards(self, orm):
        # Deleting model 'EarlyBirdUser'
        db.delete_table(u'users_earlybirduser')
