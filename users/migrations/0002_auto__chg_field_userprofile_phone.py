...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'phone', self.gf('phonenumber_field.modelfields.PhoneNumberField')(unique=True, max_length=16))

    def backwards(self, orm):

        # Changing field 'UserProfile.phone'
        db.alter_column(u'users_userprofile', 'phone', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=10, unique=True))
