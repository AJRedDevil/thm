...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserProfile', fields ['userref']
        db.create_unique(u'users_userprofile', ['userref'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['userref']
        db.delete_unique(u'users_userprofile', ['userref'])
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'13bbc94625714937acccdc72d7dfc580'", 'unique': 'True', 'max_length': '100'})
        },
        u'users.usertoken': {
