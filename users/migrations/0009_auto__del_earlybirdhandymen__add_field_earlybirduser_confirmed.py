...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EarlyBirdUser.confirmed'
        db.add_column(u'users_earlybirduser', 'confirmed',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'users_earlybirdhandymen', (
            ('phone', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=16, unique=True)),
        ...
        # Deleting field 'EarlyBirdUser.confirmed'
        db.delete_column(u'users_earlybirduser', 'confirmed')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'37905e0f07c14ce1814006eca1f1e2b3'", 'unique': 'True', 'max_length': '100'})
        },
        u'users.usertoken': {
